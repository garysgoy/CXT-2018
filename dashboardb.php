                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" style="width:100%;height:230px">
                                    ...
                                    <tr>
                                        ...
                                        <td class="warning" style="text-align:center;vertical-align:middle;"><? echo $user->qc ;?></td>
...
function sub_fc()
{
  ...
  $.post("_doPh.php",{pass2:pass2,kou_pin_nums:kou_pin_nums,HelpAmount:fc_amount},function(result){
    //var result = eval("("+result+")");
    if(result['status'] == 'success')
    {
      alert(result['msg']);
