    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="myModalContent_report">
                <form class="form-horizontal" method="post" action="dashboard_upload.php" enctype="multipart/form-data">

                    <input type="hidden" name="pp_id" id="pp_id"/>
                    <input type="hidden" name="report_user_id" id="report_user_id" value="153"/>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" style="width:100%;height:230px">
                                    ...
                                    <tr>
                                        ...
                                        <td class="warning" style="text-align:center;vertical-align:middle;">1</td>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane animated fadeIn active" id="help">
                                                <div class="list-group no-radius row">
                                                        ...
                                                        <span class="col-lg-3 block"><i class="fa fa-dot-circle-o m-r-sm text-primary"></i>单号：HE125577B45E270D84AC58AD06</span>
                                                        <span class="col-lg-2 block">金额：<span class="text-danger">￥2000.00</span></span>
                                                        <span class="col-lg-3 block">预期收益：2300.00</span>
                                                        <span class="col-lg-3 block">时间：2017-12-23 18:12:04</span>
                                                        ...
                                                        <span class="col-lg-2 block">已打款单数：0</span>
                                                                                                    ...
                                                                                                    <a class="list-group-item clearfix" href="javascript:;">
                                                        <span class="col-lg-3 block"><i class="fa fa-dot-circle-o m-r-sm text-primary"></i>单号：HCF34650317CA1430D9FE35B97</span>
                                                        <span class="col-lg-2 block">金额：<span class="text-danger">￥2000.00</span></span>
                                                        <span class="col-lg-3 block">预期收益：2300.00</span>
                                                        <span class="col-lg-3 block">时间：2017-12-18 20:29:34</span>
                                                        <span class="col-lg-2 block">分配受单数：1</span>
                                                        <span class="col-lg-2 block">已打款单数：0</span>
                                                    </a>

                                                                                                                                                                                                                                                            <a class="list-group-item clearfix" href="javascript:;" style="background:rgb(227,185,222);">
                                        <span class="col-lg-3 block">用户名：<span class="text-danger">17764119919</span></span>
                                          <span class="col-lg-3 block">受益人姓名：<span class="text-danger">郭亚兴</span></span>
                                          <span class="col-lg-3 block">
                                            受益人电话：17764119919                                         </span>
                                          <span class="col-lg-3 block">金额：<b style="color:red;">2000.00</b></span>

                                          <span class="col-lg-3 block">
                                            推荐人姓名：李廷鸿                                         </span>
                                          <span class="col-lg-3 block">
                                            推荐人电话：13604001347                                         </span>

                                          <span class="col-lg-3 block">截止付款时间：2017-12-26 15:01:59</span>
                                          <span class="col-lg-3 block">状态：<b style="color:red;">

                                                                                          配对成功,打款中                                                                                      </b></span>

                                          <span class="col-lg-3 block">
                                                                            <input type="button" class="btn btn-info" value="上传支付凭证" data-toggle="modal" data-target="#uppz_modal" onclick="show_upload_pz(105)"/>
                                &nbsp;&nbsp;
                                            ...
                                            <div class="tab-pane animated fadeIn" id="shelp">
                                                <div class="list-group no-radius row">
                                                    ...
                                                    <a class="list-group-item clearfix" href="javascript:;">
                                                        <span class="col-lg-3 block"><i class="fa fa-dot-circle-o m-r-sm text-primary"></i>单号：G2216159AD7575BCF41A82DE53</span>
                                                        <span class="col-lg-2 block">金额：<span class="text-danger">￥100.00</span></span>
                                                        <span class="col-lg-3 block">时间：2017-12-25 20:11:46</span>
                                          ...
                                          <span class="col-lg-3 block">用户名：lcy002</span>
                                                        <span class="col-lg-3 block">付出者：黎长永</span>
                                                        <span class="col-lg-3 block">电话：18640685866</span></span>
                                                        <span class="col-lg-3 block">付出金额：100.00</span>
                                          ...
                                          -->
                                            <span class="col-lg-3 block">支付方式：支付宝</span>
                                            <span class="col-lg-3 block">付款时间：2017-12-26 09:34:57</span>

                                                                                                                                    <span class="col-lg-3 block">确认截止时间：2017-12-26 13:34:57</span>

                                            <span class="col-lg-3 block">确认付款剩余时间：
                                            <input type="hidden" name="hid_last_sure_time" value="2017-12-26 13:34:57"/>
                                              <b style="color:red;">
                                                2小时30分16秒                                             </b>
                                            </span>

                                            <span class="col-lg-3 block">
                                                <input type="button" class="btn btn-info" value="查看支付凭证"  onclick="show_pz('data/uploads/pz/2017/12/26/0362658b8949931a48fbf6fe9cfc0525.png')"/>

                                            </span>
                                           <span class="col-lg-3 block">
                                              <input type="button" value="确认付款" fcuid="46" ddid="155" class="btn btn-info" style="padding:5px 6px" id="btn_sub_sure" onclick="sub_sure(this)"/>
                                            </span>
                                            <!--
                                            <input type="hidden" name="fcuid" id="fcuid" value="46">
                              <input type="hidden" name="ddid" id="ddid" value="155">
                              -->
                            <!--
                                          </form>
                                          -->
                                                                                                    <span class="col-lg-3 block">
                                                      <a style="background:red;" class="btn btn-info" style="padding:5px 6px" data-container="body" data-toggle="modal" data-target="#report_modal" onclick="rec(155)"/>举报</a>
                                                  </span>
                                                                                                                                              </div>
